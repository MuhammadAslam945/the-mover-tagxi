<?php $__env->startSection('title', 'ServiceLocation'); ?>
        ...
        <div class="row">
            <div class="col-12">
                <div class="box">
                    ...
                    <?php if(auth()->user()->can('Add_Service_Location')): ?>         
                            
                            <div class="col-md-7 text-center text-md-right">
                                <a href="<?php echo e(url('service_location/create')); ?>" class="btn btn-primary btn-sm">
                                    <i class="mdi mdi-plus-circle mr-2"></i><?php echo app('translator')->get('view_pages.add_service_location'); ?></a>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/tagxi-server-app-laravel-8/resources/views/admin/servicelocation/index.blade.php ENDPATH**/ ?>