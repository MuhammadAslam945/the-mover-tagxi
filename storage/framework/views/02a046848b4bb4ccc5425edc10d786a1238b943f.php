...
<div class="content">
            ...
            <div class="col-sm-12">
                <div class="box">
                    ...
                    <ul class="nav nav-tabs" style="padding: 1rem">
                        ...
                        <li class="nav-item">
                            <a href="#<?php echo e($setting_key); ?>" data-toggle="tab" aria-expanded="false" class="nav-link <?php if ($tab==1) {
    echo "active";
}?>"> <?php echo e(trans('view_pages.'.$setting_key)); ?>
                    ...
                    <form action="<?php echo e(url('system/settings')); ?>" method="post" enctype="multipart/form-data" >
                        <?php echo csrf_field(); ?>
    ...
    echo "active";
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12" >
                                    <h5><?php echo e(trans('view_pages.'.$group_name)); ?></h5>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="title">
                                            <?php echo e(trans('view_pages.'.$setting_name['name'])); ?>
                      ...
                      /*image box*/     elseif ($setting_name['field']=="file") { ?>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-6">
                                                                <img id="blah" src="<?php echo e($setting_name['name'] == 'logo' ? app_logo() : fav_icon()); ?>" alt="" style="max-width: 250px; max-height: 250px"><br>
                                                                <input type="file" id="<?php echo e($setting_name['name']); ?>" onchange="readURL(this)" name="<?php echo e($setting_name['name']); ?>" style="display:none"><br>
                                                                <button class="btn btn-primary btn-sm" type="button" onclick="$(<?php echo e($setting_name['name']); ?>).click()" id="upload"><?php echo app('translator')->get('view_pages.browse'); ?></button>
                                                                ...
                                                                <span class="text-danger"><?php echo e($errors->first($setting_name['name'])); ?></span>
                                                            </div>
                                                        </div>
                      ...
                      /*text area  */   elseif ($setting_name['field']=="textarea") { ?>
                                ...
                                <div class="form-group text-right m-b-0">
                                    <button class="btn btn-custom waves-effect waves-light" type="submit">
                                        <?php echo e(trans('view_pages.save')); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/tagxi-server-app-laravel-8/resources/views/admin/master/settings.blade.php ENDPATH**/ ?>