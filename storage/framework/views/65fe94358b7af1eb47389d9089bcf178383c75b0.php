            ...
            <div class="box">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div id="legend"><h3><?php echo app('translator')->get('view_pages.legend'); ?></h3></div>
                    </div>
                </div>
...
<script type="text/javascript" src="https://maps.google.com/maps/api/js?key=<?php echo e(get_settings('google_map_key')); ?>&libraries=visualization"></script>
...
<script type="text/javascript">
    ...
    var pickLat = [];
    var pickLng = [];
     var default_lat = '<?php echo e($default_lat); ?>';
    var default_lng = '<?php echo e($default_lng); ?>';
     var company_key='<?php echo e(auth()->user()->company_key); ?>';
...
var firebaseConfig = {
    ...
    var map = new google.maps.Map(document.getElementById('map'), {
        ...
        var iconBase = '<?php echo e(asset("map/icon/")); ?>';
        var icons = {
          car_available: {
            name: 'Available',
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/tagxi-server-app-laravel-8/resources/views/admin/map/map.blade.php ENDPATH**/ ?>